...
describe('Comment API:', function () {
  ...
  describe('GET /api/comments', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/comments').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        comments = res.body;
  ...
  describe('POST /api/comments', function () {
    beforeEach(function (done) {
      (0, _supertest2.default)(app).post('/api/comments').send({
        name: 'New Comment',
  ...
  describe('GET /api/comments/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).get('/api/comments/' + newComment._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        comment = res.body;
  ...
  describe('PUT /api/comments/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2.default)(app).put('/api/comments/' + newComment._id).send({
  ...
  describe('DELETE /api/comments/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2.default)(app).delete('/api/comments/' + newComment._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when comment does not exist', function (done) {
      (0, _supertest2.default)(app).delete('/api/comments/' + newComment._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=comment.integration.js.map
